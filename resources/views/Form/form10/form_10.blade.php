...
<div class="form-card">
  ...
  <div class="top-header">
    <div class="logo-area">
      <div class="logo-box">UNICO<br>HOSPITALS</div>
      <div class="hosp-name">Unico Hospitals</div>
    </div>
    <div class="title-area">
      <h1>End-of-Life Care Form (ELF)</h1>
    </div>
    <div class="patient-label-box">
      <div class="lbl-title">Patient Label</div>
      <div class="lbl-row"><span>Invoice No.:</span><span class="lbl-line"></span></div>
      <div class="lbl-row"><span>UHID:</span><span class="lbl-line"></span></div>
      <div class="lbl-row"><span>Patient name:</span><span class="lbl-line"></span></div>
      <div class="lbl-row"><span>Consultant name:</span><span class="lbl-line"></span></div>
      <div class="lbl-row">
        <span>Age:</span>
        <input type="text" style="width:24px;height:15px;font-size:9px;padding:1px 2px;border:none;border-bottom:1px solid var(--border);background:transparent;outline:none;">
        <span>Day</span>
        <input type="text" style="width:20px;height:15px;font-size:9px;padding:1px 2px;border:none;border-bottom:1px solid var(--border);background:transparent;outline:none;">
        <span>Month</span>
        <input type="text" style="width:22px;height:15px;font-size:9px;padding:1px 2px;border:none;border-bottom:1px solid var(--border);background:transparent;outline:none;">
        <span>Year</span>
      </div>
      <div class="lbl-row"><span>Mobile no.:</span><span class="lbl-line"></span></div>
      <div class="lbl-row"><span>Print:</span><span class="lbl-line"></span></div>
    </div>
  </div>

  <!-- PATIENT BAR -->
  <div class="patient-bar">
    <div class="pb-cell"><label>Patient's Name:</label><input type="text" name="patient_name" placeholder="Full Name"></div>
