...
<head>
  ...
  <link rel="icon" type="image/png" sizes="192x192"  src="{{asset('assets/img/favicon/android-icon-192x192.png')}}">
  ...
  <meta name="theme-color" content="#ffffff">
    ...
    <link rel="icon" src="{{ asset('img/favicon_icon.png') }}" type="image/png">
